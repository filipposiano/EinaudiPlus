...
const nap: Partial<Testi> = {
  ...
  legendInUse:    (t: string): string => `Giall — A stann usann — Turno 'e mo, fernesce ê ${t}.`,
  ...
  navRicorrenti: "Ricorrent", navNotifiche: "Notifiche", navManutenzione: "Manutenzion", navTema: "Tema",
  ...
  privacyConservazioneBody: "'E prenotazioni restano visibili pe' 'a semmana corrente e chella primma, po' vengono cancellate 'a sole. 'E segnalazioni e 'e registre tecnici vengono cancellate doppo 180 juorne. L'iscrizione ê promemoria (push o Telegram) resta fino a quanno nun 'a disattive tu stesso dint' 'e Impostazioni, o scrive /stop 'o bot Telegram.",
