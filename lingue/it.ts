...
const it = {
  ...
  privacyDatiBody: "Il numero di camera che inserisci per accedere; se attivi i promemoria, l'identificativo del dispositivo (per le notifiche push) o della chat (per Telegram); il testo delle segnalazioni che invii. Non ti chiediamo nome, cognome o altri dati anagrafici: il numero di camera resta comunque un dato che può risalire a te, per chi sa chi vive in quella stanza.",
  ...
  privacyDirittiBody: "Puoi disattivare i promemoria in qualsiasi momento dalle Impostazioni: cancella subito l'iscrizione push o Telegram collegata al tuo dispositivo. Per accedere, correggere o cancellare gli altri dati che ti riguardano (es. una segnalazione inviata), contatta chi gestisce l'app.",
